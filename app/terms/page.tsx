          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                By accessing and using YtToolBox, you accept and agree to be
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Our services are provided free of charge for personal and
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                YtToolBox and its original content, features, and functionality
                are owned by YtToolBox and are protected by international
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                kind. We do not guarantee that our services will be
                uninterrupted, secure, or error-free. You use our services at
                your own risk.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                YtToolBox shall not be liable for any indirect, incidental,
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Our services interact with YouTube content. We are not
                responsible for the content, accuracy, or availability of
                third-party materials. All YouTube content is subject to
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                <a href="/contact" className="text-purple-main hover:underline">
                  contact page
                </a>
                .
              </p>
