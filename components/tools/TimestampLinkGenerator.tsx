...
import { MdContentCopy, MdAutoFixHigh } from "react-icons/md";
    ...
    <>
      <div className="max-w-3xl mx-auto py-8 px-4">
        <div className="text-center mb-8">
          ...
          <div className="mt-4">
            <a
              href="/youtube-timestamp-link-generator-guide"
        ...
        <div className="border border-gray-200 rounded-xl bg-linear-to-br from-white to-gray-50 shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
            ...
            {generatedLink && (
              <div className="mt-8">
                ...
                <div className="p-4 flex items-center gap-4 bg-gray-50 border border-gray-200 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
                  <p className="grow overflow-hidden text-ellipsis whitespace-nowrap font-mono text-sm text-[#333333]">
                    {generatedLink}
                  </p>
                  <button
                    onClick={copyToClipboard}
                    className={`${
                      copied ? "bg-youtube-dark" : "bg-youtube-red"
          ...
          <div className="p-8 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4">
                ...
                <p className="text-sm text-black">
                  Enter the exact time (hours, minutes, seconds) where you want
                  the video to start
                </p>
              </div>
              <div className="text-center p-4">
                ...
                <p className="text-sm text-black">
                  Click the generate button to create your custom timestamp link
                </p>
              </div>
              <div className="text-center p-4">
                <div className="bg-youtube-red text-white w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4 font-bold">
        ...
        <div className="mt-8 mb-12">
          ...
          <div className="space-y-6">
            <div>
              <h6 className="font-semibold text-black mb-2">
                What is a YouTube timestamp link?
              </h6>
              <p className="text-black">
                A YouTube timestamp link is a special URL that starts a video at
                a specific time. Instead of starting from the beginning, viewers
                will jump directly to the timestamp you specify.
              </p>
            </div>
            <div>
              <h6 className="font-semibold text-black mb-2">
              ...
              <p className="text-black">
                ...
                youtube.com/embed/VIDEO_ID, and any variations with additional
                parameters.
              </p>
            </div>
            <div>
              ...
              <p className="text-black">
                ...
                the hours, minutes, and seconds fields accordingly.
              </p>
            </div>
            <div>
              <h6 className="font-semibold text-black mb-2">
