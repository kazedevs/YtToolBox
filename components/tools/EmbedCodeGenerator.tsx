    ...
    <>
      <div className="max-w-3xl mx-auto py-8 px-4">
        <div className="text-center mb-8">
          ...
          <div className="mt-4">
            <a
              href="/youtube-embed-code-generator-guide"
        ...
        <div className="mt-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-black">
                Yes! You can adjust the width and height values to fit your
                website's layout perfectly.
              </p>
            </div>
            <div>
              <h6 className="font-semibold text-black mb-2">
              ...
              <p className="text-black">
                The generated code will work on all devices. For fully
                responsive design, you may need to add CSS wrapper styling.
              </p>
            </div>
          </div>
        </div>
