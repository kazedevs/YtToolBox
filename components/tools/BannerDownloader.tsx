  ...
  const handleFetch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/channel-banner?id=${encodeURIComponent(channelId)}`
      );
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12 flex justify-center">
        <div className="text-center max-w-4xl">
          ...
          <div className="mt-4">
            <a
              href="/youtube-banner-downloader-guide"
              ...
              {bannerData && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={() =>
                        handleDownload(bannerData.banners.mobile, "mobile")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleDownload(bannerData.banners.tablet, "tablet")
                      }
                      className="py-3 px-4 font-semibold rounded-xl text-sm bg-purple-main text-white hover:bg-purple-dark transition-colors flex items-center justify-center gap-2"
                    >
                      <MdDownload className="text-xl" />
                    ...
                    <button
                      onClick={() =>
                        handleDownload(bannerData.banners.desktop, "desktop")
                      }
                      className="py-3 px-4 font-semibold rounded-xl text-sm bg-purple-main text-white hover:bg-purple-dark transition-colors flex items-center justify-center gap-2"
                    >
                      <MdDownload className="text-xl" />
                    ...
                    <button
                      onClick={() =>
                        handleDownload(bannerData.banners.tv, "tv")
                      }
                      className="py-3 px-4 font-semibold rounded-xl text-sm bg-purple-main text-white hover:bg-purple-dark transition-colors flex items-center justify-center gap-2"
                    >
                      <MdDownload className="text-xl" />
                  ...
                  <button
                    onClick={() =>
                      handleDownload(bannerData.banners.original, "original")
                    }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="h-full rounded-2xl bg-white border border-gray-200">
            <div className="p-8 text-center h-full flex flex-col">
              ...
              <h4 className="text-lg font-bold mb-4 text-black">Paste URL</h4>
          ...
          <div className="h-full rounded-2xl bg-white border border-gray-200">
            <div className="p-8 text-center h-full flex flex-col">
              ...
              <h4 className="text-lg font-bold mb-4 text-black">Process</h4>
              <p className="grow text-sm text-[#606060]">
          ...
          <div className="h-full rounded-2xl bg-white border border-gray-200">
            <div className="p-8 text-center h-full flex flex-col">
              ...
              <h4 className="text-lg font-bold mb-4 text-black">Download</h4>
              <p className="grow text-sm text-[#606060]">
