      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr 1fr', md: 'repeat(4, 1fr)' }, gap: 4 }}>
        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <MuiLink component={Link} to="/tools/timestamp-link-generator" color="text.secondary" variant="body2" sx={{ textDecoration: 'none' }}>
              Timestamp Link Generator
            </MuiLink>
            <MuiLink component={Link} to="/tools/embed-code-generator" color="text.secondary" variant="body2" sx={{ textDecoration: 'none' }}>
